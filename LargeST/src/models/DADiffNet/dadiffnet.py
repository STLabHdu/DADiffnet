...
from .mlp import GraphMLP, MultiLayerPerceptron, FeatureTransformerBlock, GraphExtractBlock
...
class DADiffNet(BaseModel):
    ...
    def __init__(self, supports, model_args, **args):
        ...
        self.fusion_num_step = model_args["graph_num_step"]
        self.fusion_num_layer = model_args["graph_num_layer"]
        self.fusion_dim = model_args["graph_dim"]
        self.fusion_out_dim = model_args["graph_out_dim"]
        self.fusion_dropout = model_args["graph_dropout"]
    ...
    def forward(self, history_data, label, his):  # (b, t, n, f)
        ...
        his_input_data = his[..., 0].transpose(1, 2)
